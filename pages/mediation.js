...
const MediationImage = () => {
  return (
    <img alt='mediation' src='/images/process0a-mediation-400x400.png' width='100px' height='100px'/>
  );
}

const ProcessImage = () => {
  return (
    <img alt='process' src='/images/process0b-process-400x400.png' />
  );
}

const AgreementImage = () => {
  return (
    <img alt='agreement' src='/images/process0c-agreement-400x400.png' />
  );
}
...
const Mediation = () => {
  return (
    <div className={montserratFont.className}
      ...
      <h1 className={halantFont.className}>What is Mediation?</h1>
      <p>
